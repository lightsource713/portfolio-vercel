        ...
        <div className="mt-[14rem] flex w-full flex-col items-start justify-center lg:flex-row">
          <div className="flex w-full flex-col items-start justify-center lg:w-2/3">
            ...
            <p className="mt-2 text-left text-xl">
              I am experienced and passionate Fullstack engineer with +5 years
              of experience. Designed and accomplished the development of a
              Manufacturing Execution System (MES) with my team members,
              demonstrating my versatility and expertise in diverse projects.
              And equipped with wide range of tech stack including frontend and
              ...
              digital world and continuously enhancing skillset. Very flexible
              in work and communicative with teammates
            </p>
          </div>
